...
public class FileIO 
{
    ...
    {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("./Resources/boardData.txt"))) 
        {
    ...
    {
        try(BufferedReader br = new BufferedReader(new FileReader("./Resources/boardData.txt")))
        {
